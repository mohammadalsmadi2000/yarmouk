...
class Library extends Component {
  state = {
      mapRegion: { latitude: 32.539558, longitude:35.853241,   latitudeDelta: 0.003,longitudeDelta: 0.003},
      locationResult: null,
      location: {coords: { latitude: 32.539558, longitude:35.853241}},
    };
    componentWillMount() {
                            ...
                            <View style={{ marginTop: 40, paddingHorizontal: 20 }}>
                                ...
                                <ScrollView horizontal={true} pageEnabled={true}>
                                  <Card style={{flex: 0,margin:10,paddingHorizontal:10}}>
                                      ...
                                      <CardItem cardBody>
                                        <Image source={{uri: 'https://khaberni-6zrocpuaymq7.stackpathdns.com/uploads/news_model/images/171443_27_1470580354.JPG'}} style={{height: 200, width: null, flex: 1}}/>
                                      </CardItem>
