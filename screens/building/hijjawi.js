...
class Hijjawi extends Component {
  state = {
      mapRegion: { latitude: 32.535538, longitude:35.855209,   latitudeDelta: 0.003,longitudeDelta: 0.003},
      locationResult: null,
      location: {coords: { latitude: 32.535538, longitude:35.855209}},
    };
    componentWillMount() {
                            ...
                            <View style={{ marginTop: 40, paddingHorizontal: 20 }}>
                                ...
                                <ScrollView horizontal={true} pageEnabled={true}>
                                  <Card style={{flex: 0,margin:10,paddingHorizontal:10}}>
                                      ...
                                      <CardItem cardBody>
                                        <Image source={{uri: 'https://photos.wikimapia.org/p/00/04/19/28/73_big.jpg'}} style={{height: 200, width: null, flex: 1}}/>
                                      </CardItem>
